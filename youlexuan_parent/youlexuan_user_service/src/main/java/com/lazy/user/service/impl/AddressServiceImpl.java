...
import com.lazy.mapper.TbAddressMapper;
import com.lazy.pojo.TbAddress;
import com.lazy.pojo.TbAddressExample;
import com.lazy.pojo.TbAddressExample.Criteria;
import com.lazy.user.service.AddressService;
...
public class AddressServiceImpl implements AddressService {
	...
	public List<TbAddress> findListByUserId(String userId) {
		...
		List<TbAddress> addressList = addressMapper.selectByExample(ex);
		return addressList;
	}
